package com.miftahjuanda.myviewmodel;
...
public class MyButton extends android.support.v7.widget.AppCompatButton {
    ...
    public void onDraw(Canvas canvas){
        super.onDraw(canvas);
        setBackground(isEnabled() ? disableBackground : enableBackground);
    ...
    private void init(){
        ...
        disableBackground = getResources().getDrawable(R.drawable.bg_button_disabel);
    }
}